...
public class ChefArmInstance extends SingleRotatingInstance implements DynamicInstance {
	...
	private final ChefMechanicalArmTile arm;
	...
	public ChefArmInstance(MaterialManager modelManager, ChefMechanicalArmTile tile) {
		...
		arm = tile;
		ceiling = blockState.getValue(ChefMechanicalArm.CEILING);
	...
	public void beginFrame() {
		if (arm.phase == ChefMechanicalArmTile.Phase.DANCING && blockEntity.getSpeed() != 0) {
			animateArm(true);
			firstRender = true;
			return;
		}
