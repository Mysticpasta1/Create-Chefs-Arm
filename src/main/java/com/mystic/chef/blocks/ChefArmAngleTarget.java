...
public class ChefArmAngleTarget {

	static final ChefArmAngleTarget NO_TARGET = new ChefArmAngleTarget();
	...
	private ChefArmAngleTarget() {
		lowerArmAngle = 155;
		upperArmAngle = 60;
		headAngle = -15;
	}

	public ChefArmAngleTarget(BlockPos armPos, Vec3 pointTarget, Direction clawFacing, boolean ceiling) {
//		if (ceiling) 
